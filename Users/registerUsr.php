...
<div class="container">
    <div class="form-body">
        <fieldset><legend><h1>Signup</h1></legend>
            <form method="post" action="../config/usersconfig.php" enctype="multipart/form-data">
            <div class="inside-form">
                ...
                <fieldset><legend>Company Details</legend>
                    ...
                    <div class="row">
                        <div >
                            <input class="col-md-6"  type="text" required placeholder="Company Address" name="Companyzip">
                        </div>
                    </div>
                    <div class="row">
                        <div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <input type="file" id="logo" name="companyLogo" accept=".gif, .jpg, .png">
                        </div>
                    </div>
                    <div class="row">
                        <div>
